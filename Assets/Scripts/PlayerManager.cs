...
{
    public static Player player1 = new(100, 80, 50); // Create Player 1 with 0 attack, 0 defence, and 50 health
    public static Player player2 = new(120, 90, 90); // Create Player 2 with 0 attack, 0 defence, and 50 health
